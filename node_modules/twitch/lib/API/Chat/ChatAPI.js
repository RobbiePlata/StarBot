...
var ChatAPI = /** @class */ (function (_super) {
     ...
     */
    ChatAPI.prototype.getGlobalBadges = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, new ChatBadgeList_1.default(data, this._client)];
                }
            });
        });
    };
     ...
     */
    ChatAPI.prototype.getChannelBadges = function (channel, includeGlobal) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this._client.callAPI({
                            url: "https://badges.twitch.tv/badges/channel/" + UserTools_1.default.getUserId(channel) + "/display",
                            type: TwitchClient_1.TwitchAPICallType.Custom
                        })];
                    case 1:
                        data = _c.sent();
    ...
    ChatAPI.prototype.getChatRoomsForChannel = function (channel) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._client.callAPI({
                            url: "chat/" + UserTools_1.default.getUserId(channel) + "/rooms"
                        })];
                    case 1:
                        data = _a.sent();
    ...
    ], ChatAPI.prototype, "getGlobalBadges", null);
    tslib_1.__decorate([
        Decorators_1.Cached(3600)
    ], ChatAPI.prototype, "getChannelBadges", null);
    tslib_1.__decorate([
        Decorators_1.Cached(3600)

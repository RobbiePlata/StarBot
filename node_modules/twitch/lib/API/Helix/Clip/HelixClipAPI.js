...
var HelixClipAPI = /** @class */ (function (_super) {
     ...
     */
    HelixClipAPI.prototype.getClipsForBroadcaster = function (id, pagination) {
        return this._getClips(tslib_1.__assign({}, pagination, { filterType: 'broadcaster_id', ids: id }));
    };
    /**
     ...
     * @param pagination Parameters for pagination.
     */
    HelixClipAPI.prototype.getClipsForGame = function (id, pagination) {
        return this._getClips(tslib_1.__assign({}, pagination, { filterType: 'game_id', ids: id }));
    };
    /**
    ...
    HelixClipAPI.prototype._getClips = function (params) {
        var _this = this;
        var _a;
        var filterType = params.filterType, ids = params.ids, after = params.after, before = params.before, limit = params.limit;

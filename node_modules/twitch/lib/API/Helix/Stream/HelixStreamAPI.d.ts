...
export default class HelixStreamAPI extends BaseAPI {
     ...
     */
    getStreams(filter?: HelixStreamFilter): HelixPaginatedRequest<HelixStreamData, HelixStream>;
    /**
     * Retrieves the current stream for the given user name.
     *
     * @param userName The user name to retrieve the stream for.
     */
    getStreamByUserName(userName: string): Promise<HelixStream | null>;
    /**
     ...
     */
    getStreamMarkersForUser(user: UserIdResolvable): HelixPaginatedRequest<HelixStreamGetMarkersResult, HelixStreamMarkerWithVideo>;
    /**
     * Retrieves a list of all stream markers for a video.
     *
     * @param videoId The video to list the stream markers for.
     */
    getStreamMarkersForVideo(videoId: string): HelixPaginatedRequest<HelixStreamGetMarkersResult, HelixStreamMarkerWithVideo>;
    /**

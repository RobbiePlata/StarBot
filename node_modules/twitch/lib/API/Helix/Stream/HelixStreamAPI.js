...
var HelixStreamAPI = /** @class */ (function (_super) {
    ...
    HelixStreamAPI.prototype.getStreamByUserName = function (userName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req = this.getStreams({ userName: userName });
    ...
    HelixStreamAPI.prototype.getStreamByUserId = function (user) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req = this.getStreams({ userId: UserTools_1.default.getUserId(user) });
                        return [4 /*yield*/, req.getAll()];
                    case 1:
                        streams = _a.sent();
                        return [2 /*return*/, streams.length ? streams[0] : null];
    ...
    HelixStreamAPI.prototype._getStreamMarkers = function (queryType, id) {
        ...
        }, this._client, function (data) { return data.videos.reduce(function (result, video) { return result.concat(video.markers.map(function (marker) { return new HelixStreamMarkerWithVideo_1.default(marker, video.video_id, _this._client); })); }, []); });
    };
    /**
    ...
    HelixStreamAPI.prototype.getStreamMarkersForUser = function (user) {
        return this._getStreamMarkers('user_id', UserTools_1.default.getUserId(user));
    };
    /**
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        if ((e_1 instanceof errors_1.StatusCodeError) && e_1.statusCode === 404) {

...
/** @private */
export declare type HelixVideoFilterType = 'user_id' | 'game_id';
/** @private */
...
export default class HelixVideoAPI extends BaseAPI {
     ...
     */
    getVideosByUser(user: UserIdResolvable): Promise<HelixPaginatedRequest<HelixVideoData, HelixVideo>>;
    /**
     * Retrieves the videos of the given game.
     *
     * @param gameId The game you want to retrieve videos from.
     */
    getVideosByGame(gameId: string): Promise<HelixPaginatedRequest<HelixVideoData, HelixVideo>>;
    private _getVideos;
}

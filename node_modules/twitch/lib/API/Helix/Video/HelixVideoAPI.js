...
var HelixVideoAPI = /** @class */ (function (_super) {
     ...
     */
    HelixVideoAPI.prototype.getVideosByUser = function (user) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var userId;
            return tslib_1.__generator(this, function (_a) {
                userId = UserTools_1.default.getUserId(user);
                return [2 /*return*/, this._getVideos('user_id', userId)];
            });
        });
    };
    /**
     ...
     */
    HelixVideoAPI.prototype.getVideosByGame = function (gameId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                // TODO next major: this method should not be async
                return [2 /*return*/, this._getVideos('game_id', gameId)];
            });
        });
    };

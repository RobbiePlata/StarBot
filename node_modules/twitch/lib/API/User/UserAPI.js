    ...
    UserAPI.prototype.getUser = function (userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._client.callAPI({ url: "users/" + UserTools_1.default.getUserId(userId) })];
                    case 1:
                        userData = _a.sent();
                        if (!userData) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        users = ObjectTools_1.default.indexBy(usersArr, 'name');
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        tokenInfo = _a.sent();
                        if (!tokenInfo.valid) {
                            throw new AuthorizationError_1.default('Authorization necessary to get emotes');
                        }
                        userId = tokenInfo.userId;
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this._client.callAPI({ url: "users/" + userId + "/emotes", scope: 'user_subscriptions' })];
                    case 4:
                        data = _a.sent();
